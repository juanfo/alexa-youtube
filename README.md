...
7. Delete everything in the text box, and copy in the text from https://raw.githubusercontent.com/ndg63276/alexa-youtube/master/InteractionModel.json. If you want to use it in spanish copy the text from InteractionModel.es.json
